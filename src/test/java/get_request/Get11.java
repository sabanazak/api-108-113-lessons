    ...
    public void get11() {
        ...
        response.then().assertThat()
                ...
                .body("meta.pagination.limit",equalTo(10),
                        ...
                        "data.name",hasItems("Pres. Soma Adiga", "Ms. Anjushree Shah"));

        //long fm = genders.stream().filter(t->t.equals("female")).count();
        ...
        //or
        long femaleCount = genders.stream().filter(t->t.equals("female")).count();
