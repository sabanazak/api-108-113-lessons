...
public class Get18QmiBank extends QmiBankBaseUrl {
    ...
    public void get18(){
        ...
        System.out.println(expectedData);
        //Send the resonse and get the responce
        Response response=given().spec(spec).
                            headers("Authorization","Bearer " + generateToken()).when().get("/{first}/{second}");
        ...
        assertTrue(Objects.equals(country.getStates(),actualData.getCountry().getStates()));
